...
<fieldset>
    <legend>参加中（高）考或调研测试命题、督导视导、职称评定等工作情况</legend>
   <div class="container">
		...
		<div class="row">
			...
			<div class="span4">
				<div class="control-group">
					<label class="control-label" for="jobDetails">工作内容</label>
					<div class="controls">
						<input type="text" name="jobDetails" placeholder="工作内容" id="jobDetails">
					</div>
				</div>
			</div>
			<div class="span4">
    ...
    <c:forEach items="${data}" var="exp">
		   <tr class="${exp.id}">
		   	...
		   	<td class="jobDetails">${exp.jobDetails}</td>
		   	...
		   	<td><a class="btn" href="<%=request.getContextPath()%>/workSurvey/delete/${exp.teacherid}/${exp.id}">删除</a></td>
		   </tr> 
    </c:forEach>
    </tbody>
	</table>
